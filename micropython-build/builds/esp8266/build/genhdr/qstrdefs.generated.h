...
QDEF(MP_QSTR_AP_MODE, (const byte*)"\xc8\x65\x07" "AP_MODE")
...
QDEF(MP_QSTR_STA_AP_MODE, (const byte*)"\x31\x2c\x0b" "STA_AP_MODE")
QDEF(MP_QSTR_STA_IF, (const byte*)"\xb3\x1b\x06" "STA_IF")
QDEF(MP_QSTR_STA_MODE, (const byte*)"\xbf\xd9\x08" "STA_MODE")
